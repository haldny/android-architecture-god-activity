...
import com.rperazzo.weatherapp.Model.OpenWeatherService;
...
public class MainActivity extends AppCompatActivity {
    ...
    private WeatherController controller = new WeatherController(OpenWeatherService.getService());
    ...
    private void onFinishLoading(FindResult<City> result){
    ...
    private void searchByName() {
        ...
        final Call<FindResult<City>> findCall = controller.GetCities(search, units, OpenWeatherService.API_KEY);
